...
public interface ActorRepository extends PagingAndSortingRepository<Actor,Long>, JpaRepository<Actor, Long>, CrudRepository<Actor, Long> {
    ...
    //This would be exposed under the URL: http://localhost:8080/actors/search/findFirstByNickName
    public Optional<Actor> findFirstByNickName(@Param("nickName") String nickName);
