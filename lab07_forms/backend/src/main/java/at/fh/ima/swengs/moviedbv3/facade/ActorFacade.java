...
public class ActorFacade {
    ...
    void mapDtoToEntity(ActorDTO dto, Actor entity) {
        ...
        entity.setPromiRating(dto.getPromiRating());
        entity.setHasPet(dto.isHasPet());
    }
    ...
    private void mapEntityToDto(Actor entity, ActorDTO dto) {
        ...
        dto.setPromiRating(entity.getPromiRating());
        dto.setHasPet(entity.isHasPet());
    }
    ...
    public ActorDTO findFirstByNickName(String nickName) {
        Actor entity = actorService.findFirstByNickName(nickName).get();
        ActorDTO dto = new ActorDTO();
        mapEntityToDto(entity, dto);
        return dto;
