...
public class ActorController {
    ...
    @GetMapping("/dto/actors/search/findFirstByNickName/{nickName}")
    ActorDTO findFirstByNickName(@PathVariable String nickName) {
        return actorFacade.findFirstByNickName(nickName);
    }
